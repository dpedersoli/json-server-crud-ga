...
var require_PacmanLoader = __commonJS({
  "node_modules/react-spinners/PacmanLoader.js"(exports) {
    ...
    function PacmanLoader(_a) {
      ...
      var wrapper = __assign({ display: "inherit", position: "relative", fontSize: 0, height: (0, unitConverter_1.cssValue)(size), width: (0, unitConverter_1.cssValue)(size) }, cssOverride);
...
// dep:react-spinners_PacmanLoader
var react_spinners_PacmanLoader_default = require_PacmanLoader();
export {
  react_spinners_PacmanLoader_default as default
};
